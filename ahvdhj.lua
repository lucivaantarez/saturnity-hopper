  getgenv().Utility = {
        ...
        AutoTrade = {
            ...
            Usernames = {"Crystal0bKingN1381", "AquawYStarz199229", "CyberYtFuryM13", "IceYTPixeliTNinja199", "PlayzMQCyberc50", "Xz_Ban3SpShift3ropPl", "Xz_Gamer2YEchozYSwit", "Xz_Turbo4hKingDhBaco", "XzDawn3KWardenJzX", "XzNightUROmegalzX199", "XzStarryvBOmegaxBSpa"}, -- Receivers to send to e.g. {"player1", "player2"} (also pickable in Trade tab)
